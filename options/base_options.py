...
class BaseOptions():
    ...
    def initialize(self, parser):
        parser.add_argument('--dataroot', default='./datasets/train', help='path to training/testing images')
        ...
        parser.add_argument('--which_model_netG', type=str, default='WTAM', help='selects model to use for netG [WTAM | MuFA_Net]')
        parser.add_argument('--model', type=str, default='WTAM', help='chooses which model to use.')
        parser.add_argument('--name', type=str, default='WTAM_exp', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--content_weight', type=float, default=1, help='the weight of content loss')
